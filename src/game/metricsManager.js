...
class MetricsManager {
  ...
  async loadDQNModel() {
    try {
      console.log('[DEBUG] Starting to load DQN model from /public/models/dqn-skill-model/model.json');
      const DQNAgent = require('./dqnAgentBrowser');
      this.dqnAgent = new DQNAgent();
      await this.dqnAgent.loadModelFromURL('/public/models/dqn-skill-model/model.json');
